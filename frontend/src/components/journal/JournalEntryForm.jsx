				...
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					<div className="form-control">
						<JournalEntryFormDropDown
							...
							onChange={handleChange}
							option1={''}
							option2={`What gave you hope today?`}
							option3={`How did you show kindness today?`}
							option4={`What are you grateful for today?`}
						/>
						<JournalEntryFormTextArea
							name={'response1'}
					...
					<div className="form-control">
						<JournalEntryFormDropDown
							...
							onChange={handleChange}
							option2={`How did you challenge yourself today?`}
							option3={`When did you feel at peace today?`}
							option4={`Who made your day better today and why?`}
							option1={''}
						/>
						<JournalEntryFormTextArea
							name={'response2'}
					...
					<div className="form-control">
						<JournalEntryFormDropDown
							...
							onChange={handleChange}
							option1={''}
							option2={`What's something that you learned today?`}
							option3={`What challenge are you ready to face tomorrow?`}
							option4={`What song would be the soundtrack to your day?`}
						/>
						<JournalEntryFormTextArea
							name={'response3'}
