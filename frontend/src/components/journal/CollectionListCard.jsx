...
const CollectionListCard = (props) => {
	return (
		<Link
			to={props.to}
			className="flex flex-1 basis-1/3 m-1 min-w-[20rem] p-6 bg-base-100 rounded-md opacity-80 hover:scale-[1.03] hover:opacity-100 transition-all ease-in-out duration-500"
		>
